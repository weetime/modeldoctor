		...
		<div className="space-y-3">
			<div className="flex flex-wrap items-center gap-4 text-sm">
				...
				<span className="text-muted-foreground">
					{t("response.size")}:{" "}
					<span className="font-mono">{response.sizeBytes}</span> B
				</span>
				<span className="text-muted-foreground">
					{t("response.ttfb")}:{" "}
					<span className="font-mono">{response.timingMs.ttfbMs}</span> ms
				</span>
				<span className="text-muted-foreground">
					{t("response.total")}:{" "}
					<span className="font-mono">{response.timingMs.totalMs}</span> ms
				</span>
			</div>
			...
			<Tabs defaultValue="body">
				...
				<TabsContent value="timing">
					<div className="space-y-1 text-sm">
						<div>
							TTFB:{" "}
							<span className="font-mono">{response.timingMs.ttfbMs} ms</span>
						</div>
						<div>
							Total:{" "}
							<span className="font-mono">{response.timingMs.totalMs} ms</span>
						</div>
					</div>
				</TabsContent>
