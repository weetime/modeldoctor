 ...
 */
import { buildChatAudioBody } from "../builders/multimodal.js";
import { isValidWav } from "../utils/wav.js";
...
export async function runChatAudioOmniProbe({
  ...
  return {
    ...
    details: {
      ...
      ...(textReply !== null ? { textReply } : {}),
      audioBytes: wavBytes,
      ...(audioB64 !== null ? { audioB64 } : {}), // frontend decodes this for the <audio> player
    },
  };
}
