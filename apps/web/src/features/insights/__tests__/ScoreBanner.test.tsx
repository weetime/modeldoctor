...
describe("ScoreBanner", () => {
  ...
  it("renders en-dash when composite is null", () => {
    r(
      <ScoreBanner
        composite={null}
        perScenario={{ inference: null, capacity: null, gateway: null, "prefix-cache-validation": null }}
        totalChecks={0}
        totalRuns={0}
        rangeDays={30}
      />,
  ...
  it("dims null sub-scores", () => {
    r(
      <ScoreBanner
        composite={92}
        perScenario={{ inference: 92, capacity: null, gateway: null, "prefix-cache-validation": null }}
        totalChecks={7}
        totalRuns={5}
        rangeDays={30}
      />,
