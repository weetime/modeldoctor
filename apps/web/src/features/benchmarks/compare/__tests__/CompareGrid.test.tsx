...
function makeGuidellmBenchmark(id: string, p95: number): Benchmark {
  return {
    id,
    userId: null,
    connectionId: null,
...
describe("CompareGrid", () => {
  it("renders one column per benchmark plus the metric label column", () => {
    const runs = [makeGuidellmBenchmark("a", 200), makeGuidellmBenchmark("b", 240)];
