...
// tau2 (agent scenario) is not inference-shaped — no ttft/itl/e2e/throughput/
...
// `core/row-descriptors.fe.ts` without implying tau2 has compare-grid rows.
export const tau2RowDescriptors: readonly MetricRowSpec[] = [];
