...
const data = {
  curve: [
    ...
    },
    {
      ...
      audioTtfpMs: { mean: 2870, p50: 2500, p99: 3804 },
      audioRtf: { mean: 0.54, p50: 0.5, p99: 0.9 },
    },
    {
      arm: "audio",
      concurrency: 64,
    ...
    },
    {
      ...
      reqPerSec: 0.9,
      outTokPerSec: 200,
      ttftMs: { mean: 80, p50: 70, p99: 200 },
      e2elMs: { mean: 5000, p50: 4800, p99: 7000 },
      audioTtfpMs: null,
      audioRtf: null,
    },
  ],
